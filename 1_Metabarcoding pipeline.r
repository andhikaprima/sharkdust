...
Rscript owi_combine -i Dust_d1_ecotag_db2020.fasta.annotated.csv -a Dust_d1_SWARM3nc_output.counts.csv -o Dust_d1_MOTUs_db202.csv
...
# 13. Collapse similar MOTUs (in R_scripts_metabarpark-master)
Rscript owi_collapse_ap -i Dust_d1_MOTUs_db2020.csv -t 0.70 -s 28 -e 67

## Output:
# Reading Dust_swarm-d1_MOTUs_editCollapse.csv database
# Database Dust_swarm-d1_MOTUs_editCollapse.csv read including 2562 sequences.
# Database Dust_swarm-d1_MOTUs_editCollapse.csv includes 2562 sequences with species name,
# Belonging to 197 unique species.
# Now collapsing species with best_identity higher than 0.7.
# 2420 sequences collapsed to 100 species.
# Written Dust_d1_MOTUs_db2020_collapsed.csv with 242 MOTUs.
